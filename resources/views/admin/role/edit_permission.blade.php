...
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        {!! Form::model($role, array('route' => array('role.update-permission', $role->id), 'method' => 'PATCH', 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
                        ...
                        <div class="row">
                           <div class="col-sm-6">
                            ...
                            <div class="col-sm-11 margintop20 clearfix text-center">
                                <div class="form-group">
                                    {!! Form::hidden('permission_id', (isset($userPermissions) && (count($userPermissions) > 0) && $userPermissions != '')? $userPermissions->permission_id : null) !!}
