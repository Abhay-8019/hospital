...
@section('content_header')
    <section class="content-header">
        <h1>
            {!! lang('common.edit_heading', lang('user.user')) !!}: #{!! $user->username !!}
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('common.edit_heading', lang('user.user')) !!}</li>
        </ol>
    </section>
@stop
@section('content')
<div id="page-wrapper">
    ...
    <div class="row">
        ...
        {!! Form::model($user, array('route' => array('user.update', $user->id), 'method' => 'PATCH', 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
            <!-- previous form id => user-form -->
            <div class="col-md-12">
                        ...
                        <div class="row">
                            <div class="col-md-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-8">
                                        {!! Form::select('hospital_id', $hospital, $hospitalId, array('class' => 'form-control select2')) !!}
                                    </div>
                                </div>
                                @endif
                                <div class="form-group">
