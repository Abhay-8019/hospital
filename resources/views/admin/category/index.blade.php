...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('category.category') !!}</li>
            <li><a href="{!! route('category.create') !!}">{!! lang('common.create_heading', lang('category.category')) !!}</a></li>
        </ol>
    </section>
@stop
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" style="position: static;">
                    <div class="panel-heading">
                        ...
                        {!! lang('category.category_list') !!}
                    </div>
                    <div class="panel-body">
                        <form id="serachable" action="{{ route('category.action') }}" method="post">
                            ...
                            <div class="col-md-3 padding0 marginbottom10">
                                ...
                                {!! Form::text('name', null, array('class' => 'form-control live-search', 'placeholder' => 'Search test by Category name')) !!}
                            </div>
                            <table id="paginate-load" data-route="{{ route('category.paginate') }}" class="table table-hover clearfix margin0 col-md-12 padding0">
                            </table>
                        </form>
                    </div>
                </div>
