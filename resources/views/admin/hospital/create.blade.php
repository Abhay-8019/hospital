...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb hidden">
            ...
            <li class="active">{!! lang('common.create_heading', lang('hospital.hospital')) !!}</li>
        </ol>
    </section>
@stop
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 padding0">
                {!! Form::open(array('method' => 'POST', 'route' => array('hospital.store'), 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        {!! Form::label('hospital_code', lang('hospital.hospital_name'), array('class' => 'col-sm-3 control-label')) !!}
                                        <div class="col-sm-2 padding0 paddingleft15">
                                            {!! Form::text('hospital_code', $hospitalCode, array('class'=>'form-control', 'readonly', 'placeholder' => 'Hospital Code')) !!}
                                        </div>
                                        <div class="col-sm-6">
                                    ...
                                    <div class="form-group hidden">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('hospital_building', null, array('class' => 'form-control', 'placeholder' => 'Buildings of Hospital')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('email', null, array('class' => 'form-control', 'placeholder' => 'example@gmail.com', 'id' => 'email')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                {!! Form::text('mobile', null, array('class' => 'form-control', 'maxlength' => 10,'placeholder' => lang('hospital.mobile1'))) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group hidden">
                                        {!! Form::label('contact', lang('hospital.mobile2'), array('class' => 'col-sm-3 control-label')) !!}
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon">{!! lang('common.isd_code_india') !!}</span>
                                                {!! Form::text('mobile2', null, array('class' => 'form-control', 'maxlength' => 10)) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group hidden">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('email1', null, array('class' => 'form-control', 'placeholder' => 'example123@gmail.com')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8 imageDiv">
                                            ...
                                            {!! Form::label('image', lang('common.choose_image'),  array('class' => 'col-sm-4 control-label', 'id' => 'img-label')) !!}
                                    ...
                                    <div class="form-group hidden">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::textarea('correspondence_address', null, array('class' => 'form-control', 'size' => '5x4', 'placeholder' => 'Correspondence Address')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::select('state', $state, null, array('class'=>'form-control select2 padding0')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('pincode', null, array('class'=>'form-control', 'maxlength'=> 6)) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group hidden">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('timezone', null, array('class'=>'form-control', 'maxlength'=> 6, 'placeholder' => 'TimeZone')) !!}
                                        </div>
                                    </div>
