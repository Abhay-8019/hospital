...
@section('content_header')
    <section class="content-header">
        <h1>
            {!! lang('common.edit_heading', lang('menu.menu')) !!} #{!! $result->name !!}
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('common.edit_heading', lang('menu.menu')) !!}</li>
        </ol>
    </section>
@stop
@section('content')
<div id="page-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 padding0">
            {!! Form::model($result, array('route' => array('menu.update', $result->id), 'method' => 'PATCH', 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
            <div class="col-md-12">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::text('icon', ($result->icon)? $result->icon : null, array('class' => 'menuicon form-control')) !!}
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    {!! Form::textarea('dependent_routes', ($result->dependent_routes)? $result->dependent_routes : null, array('class' => 'depend_routes form-control', 'rows'=>'3')) !!}
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox col-sm-3">
                                        {!! Form::checkbox('for_devs', '1', ($result->for_devs == 1)? true : false, array('class'=>'for_devs')) !!}
                                    </label>
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox col-sm-3">
                                        {!! Form::checkbox('is_in_menu', '1', ($result->is_in_menu == 1)? true : false, array('class'=>'is_in_menu')) !!}
                                    </label>
                                </div>
                           </div>
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox col-sm-3">
                                        {!! Form::checkbox('quick_menu', '1', ($result->quick_menu == 1)? true : false, array('class'=>'quick_menu')) !!}
                                    </label>
                                </div>
                           </div>
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox col-sm-3">
                                        {!! Form::checkbox('is_common', '1', ($result->is_common == 1)? true : false, array('class'=>'is_common')) !!}
                                    </label>
                                </div>
                           </div>
                           <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <label class="checkbox col-sm-3">
                                        {!! Form::checkbox('has_child', '1', ($result->has_child == 1)? true : false, array('class'=>'has_child')) !!}
                                    </label>
                                </div>
                           </div>
                        ...
                        <div class="col-sm-12 margintop10 clearfix text-center">
                            <div class="form-group">
                                {!! Form::submit(lang('common.update'), array('class' => 'btn btn-primary', 'id' => 'menu_submit')) !!}
                            </div>
                        </div>
