...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('common.create_heading', lang('vendor.vendor')) !!}</li>
        </ol>
    </section>
@stop
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 padding0">
                {!! Form::open(array('method' => 'POST', 'route' => array('vendor.store'), 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('vendor_code', $vendorCode, array('class' => 'form-control', 'readonly')) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                {!! Form::text('contact_number', null, array('class' => 'form-control', 'placeholder' => 'Enter Mobile Number', 'maxlength' => 10)) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            ...
                                            <div class="col-sm-8 paddingright0">
                                                {!! Form::text('company_phone', null, array('class' => 'form-control', 'placeholder' => 'Phone Number', 'min' => 1, 'maxlength' => 7)) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::textarea('company_address', null, array('class' => 'form-control', 'placeholder' => 'Company Address', 'rows' => 3, 'cols' => 50)) !!}
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon">{!! lang('common.isd_code_india') !!}</span>
                                                {!! Form::text('mobile', null, array('class' => 'form-control', 'placeholder' => 'Enter Mobile Number', 'maxlength' => 10)) !!}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('account_number', null, array('class' => 'form-control', 'placeholder' => 'Account Number', 'min' => 1)) !!}
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-5">
                                    <div class="form-group required">
                                        ...
                                        <div class="col-sm-8">
                                            {!! Form::text('branch_name', null, array('class' => 'form-control', 'placeholder' => 'Branch Address')) !!}
                                        </div>
                                    </div>
