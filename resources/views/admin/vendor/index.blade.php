...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('vendor.vendor') !!}</li>
            <li><a href="{!! route('vendor.create') !!}">{!! lang('common.create_heading', lang('vendor.vendor')) !!}</a></li>
        </ol>
    </section>
@stop
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" style="position: static;">
                    <div class="panel-heading">
                        ...
                        {!! lang('vendor.vendor_list') !!}
                    </div>
                    <div class="panel-body">
                        <form id="serachable" action="{{ route('vendor.action') }}" method="post">
                            ...
                            <div class="col-md-3 padding0 marginbottom10">
                                ...
                                {!! Form::text('name', null, array('class' => 'form-control live-search', 'placeholder' => 'Search vendor by name')) !!}
                            </div>
                            <table id="paginate-load" data-route="{{ route('vendor.paginate') }}" class="table table-hover clearfix margin0 col-md-12 padding0">
                            </table>
                        </form>
                    </div>
                </div>
