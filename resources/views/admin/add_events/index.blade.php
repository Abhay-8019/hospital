...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('event.event') !!}</li>
            <li><a href="{!! route('add_events.create') !!}">{!! lang('common.create_heading', lang('event.add_events')) !!}</a></li>
        </ol>
    </section>
@stop
@section('content')
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default" style="position: static;">
                    <div class="panel-heading">
                        ...
                        {!! lang('event.event_list') !!}
                    </div>
                    <div class="panel-body">
                        <form id="serachable" action="{{ route('add_events.action') }}" method="post">
                            ...
                            <table id="paginate-load" data-route="{{ route('add_events.paginate') }}" class="table table-hover clearfix margin0 col-md-12 padding0">
                            </table>
                        </form>
                    </div>
                </div>
