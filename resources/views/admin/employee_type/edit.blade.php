...
@section('content_header')
    <section class="content-header">
        <h1>
            {!! lang('common.edit_heading', lang('employee_type.employee_type')) !!} #{!! $result->name !!}
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{!! route('employee-type.index') !!}">{!! lang('employee_type.employee') !!}</a></li>
            <li class="active">{!! lang('common.edit_heading', lang('employee_type.employee')) !!}</li>
        </ol>
    </section>
@stop
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 padding0">
                {!! Form::model($result, array('route' => array('employee-type.update', $result->id), 'method' => 'PATCH', 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
                        <!-- previous employeeType form id => employee_type-form -->
                <div class="col-md-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-external-link-square"></i> &nbsp;
                            {!! lang('employee_type.employee_detail') !!}
                        </div>
