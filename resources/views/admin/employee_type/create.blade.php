...
@section('content_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">{!! lang('common.create_heading', lang('employee_type.employee')) !!}</li>
        </ol>
    </section>
@stop
@section('content')
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-md-12 padding0">
                {!! Form::open(array('method' => 'POST', 'route' => array('employee-type.store'), 'id' => 'ajaxSave', 'class' => 'form-horizontal')) !!}
