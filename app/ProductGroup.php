...
class ProductGroup extends Model
{
    ...
    {
        if ($id) {
            $rules['name'] = 'required|unique:product_group,name,' . $id .',id,deleted_at,NULL,company_id,'.loggedInHospitalId();
            //$rules['code'] = 'required|unique:product_group,code,' . $id .',id,deleted_at,NULL,company_id,'.loggedInHospitalId();
        } else {
            $rules['name'] = 'required|unique:product_group,name,NULL,id,deleted_at,NULL,company_id,'.loggedInHospitalId();
            //$rules['code'] = 'required|unique:product_group,code,NULL,id,deleted_at,NULL,company_id,'.loggedInHospitalId();
        }
    ...
    public function getProductGroupService()
    {
        ...
        return ['' =>'-Select Medicine Group-'] + $result;
    }
