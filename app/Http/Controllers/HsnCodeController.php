...
class HsnCodeController extends Controller
{
    ...
    {
        return view('admin.hsn-code.index');
    }
    ...
    {
        return view('admin.hsn-code.create');
    }
    ...
    {
        try{
            $result = (new HsnCode)->getHsnCodes([],'','',$id);
            if(!$result){
                return validationResponse(false, 207, lang('messages.no_data_found'));
            }
            return view('admin.hsn-code.edit', compact('result'));
        }
        catch (\Exception $exception){
            return validationResponse(false, 207, lang('messages.server_error'));
        }
     ...
     * @return \Illuminate\Http\Response
     */
    public function hsnCodePaginate($pageNumber = null)
    {
        if (!\Request::isMethod('post') && !\Request::ajax()) {
            return lang('messages.server_error');
        }
        ...
        return view('admin.hsn-code.load_data', compact('data', 'total', 'page', 'perPage', 'inputs'));
    }
    ...
    {
        $isAjax = 1;
        return view('admin.hsn-code.hsn_code_modal', compact('isAjax'));
    }
    ...
    public function generateExcel() {
        ...
        $main = view('admin.hsn-code.generate_excel_load_data', compact('data'));
    ...
    public function uploadExcel()
    {
        ...
        return view('admin.hsn-code.upload_excel', compact('banks'));
    }
