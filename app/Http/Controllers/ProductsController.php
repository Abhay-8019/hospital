...
class ProductsController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('admin.products.create', compact('groups', 'unit', 'tax', 'hsnCode'));
    }
    /**
    ...
    {
        try {
            $result = (new Product)->getProducts([], 0, 0, $id);
        } catch (\Exception $exception) {
            abort(401);
        }
        ...
        $unit = (new Unit)->getUnitService();
        $tax = (new Tax)->getTaxService();
        return view('admin.products.edit', compact('result','hsnCode', 'unit', 'tax',
            'groups', 'cost', 'discount'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function productPaginate($pageNumber = null)
    {
        if (!\Request::isMethod('post') && !\Request::ajax()) {
            return lang('messages.server_error');
        }
        ...
        return view('admin.products.load_data', compact('data', 'total', 'page', 'perPage', 'inputs'));
    }
    ...
    public function generateExcel() {
        ...
        $main = view('admin.products.generate_excel_load_data', compact('data'));
    ...
    public function uploadExcel()
    {
                    ...
                    $reader->each(function($sheet) {
                        ...
                        if($name != "") {
                            ...
                            if (count($hsnID) > 0) {
                                ...
                                $store = ['hsn_code' => (int)$sheet->hsn_code, 'company_id' => loggedInHospitalId(), 'status' => 1];
        ...
        return view('admin.products.upload_excel', compact('banks'));
    }
