...
class ProductGroupController extends Controller {
	...
	public function edit($id = null)
	{
		...
		return view('admin.product-group.edit', compact('result'));
	}
	 ...
	 * @return Response
	 */
	public function productGroupPaginate($pageNumber = null)
	{
		...
		return view('admin.product-group.load_data', compact('data', 'total', 'page', 'perPage', 'inputs'));
	}
	/**
	 * Submit Modal Form
	...
	{
		$isAjax = 1;
		return view('admin.product-group.product_group_modal', compact('isAjax'));
	}
