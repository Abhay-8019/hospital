...
class Tax extends Model
{
    ...
    public function scopeCompany($query)
    {
        ...
        return $query->where('tax.company_id', loggedInHospitalId());
    }
    ...
    public function validateTax($inputs, $id = null)
    {
        // validation rule
        if ($id) {
            $rules['name'] = 'unique:tax,name,' . $id .',id,deleted_at,NULL,company_id,'.loggedInHospitalId();
            //$rules['code'] = 'unique:tax,code,' . $id .',id,deleted_at,NULL,company_id,'.loggedInHospitalId();
        } else {
            $rules['name'] = 'required|unique:tax,name,NULL,id,deleted_at,NULL,company_id,'.loggedInHospitalId();
            //$rules['code'] = 'required|unique:tax,code,NULL,id,deleted_at,NULL,company_id,'.loggedInHospitalId();
        }
        //$rules['account'] = 'required|numeric';
        $rules['cgst_rate'] = 'required|numeric|between:0,100';
        $rules['sgst_rate'] = 'required|numeric|between:0,100';
        $rules['igst_rate'] = 'required|numeric|between:0,100';
