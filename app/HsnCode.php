...
class HsnCode extends Model
{
    ...
    {
        if ($id) {
            $rules['hsn_code'] = 'required|numeric|unique:hsn_master,hsn_code,' . $id .',id,deleted_at,NULL,company_id,'.loggedInHospitalId();
        } else {
            $rules['hsn_code'] = 'required|numeric|unique:hsn_master,hsn_code,NULL,id,deleted_at,NULL,company_id,'.loggedInHospitalId();
        }
    ...
    {
        return $query->where('hsn_master.company_id', loggedInHospitalId());
    }
